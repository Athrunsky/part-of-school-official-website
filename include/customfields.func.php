...
function GetFormItem($ctag, $admintype='admin')
{
    ...
    else if($fieldType=='img'||$fieldType=='imgfile')
    {
        if($admintype=='diy') {
            ...
            $innertext = "<input type='text' name='$fieldname' id='$fieldname' style='width:300px' class='text' /> <input name='".$fieldname."_bt' type='button' class='inputbut' value='浏览...' onClick=\"SelectImage('addcontent.$fieldname','big')\" />\r\n";
        }
    }
    else if($fieldType=='media')
    {
        ...
        {
            $innertext = "<input type='text' name='$fieldname' id='$fieldname' style='width:300px' class='text' /> <input name='".$fieldname."_bt' type='button' class='inputbut' value='浏览...' onClick=\"SelectMedia('addcontent.$fieldname')\" />\r\n";
        }
    }
    else if($fieldType=='addon')
    {
        ...
        {
            $innertext = "<input type='text' name='$fieldname' id='$fieldname' style='width:300px' class='text' /> <input name='".$fieldname."_bt' type='button' class='inputbut' value='浏览...' onClick=\"SelectSoft('addcontent.$fieldname')\" />\r\n";
        }
    }
